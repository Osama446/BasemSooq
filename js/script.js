const filtered = [
  ...
  1347842, 62161607, 12252248, 7505861, 27853106, 606717, 43868446, 64804481,21350876,8599849, 340441,64804481,58959819,32550034,2602612,20552494,24270016,164746857248
];
let numberOfPages;
//let page = 0;
